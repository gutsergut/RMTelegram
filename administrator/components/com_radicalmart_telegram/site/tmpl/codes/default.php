            ...
            <?php foreach ($referralCodes as $refCode): ?>
                <div class="code-card <?php echo !$refCode->enabled ? 'expired' : ''; ?>">
                    ...
                    <div class="code-meta">
                        ...
                        <?php if (!empty($refCode->telegram_webapp_link)): ?>
                            <div class="code-meta-item uk-margin-small-top">
                                <strong>🛒 <?php echo Text::_('COM_RADICALMART_TELEGRAM_REFERRALS_WEBAPP_LINK'); ?>:</strong><br>
                                <span class="uk-text-small" style="word-break: break-all;"><?php echo htmlspecialchars($refCode->telegram_webapp_link); ?></span>
                            </div>
                        <?php endif; ?>
                    ...
                    <div class="code-actions">
                        <?php if (!empty($refCode->telegram_webapp_link)): ?>
                            <button type="button" class="copy-btn" data-code="<?php echo htmlspecialchars($refCode->telegram_webapp_link); ?>" <?php echo !$refCode->enabled ? 'disabled' : ''; ?>>
                                📋 <?php echo Text::_('COM_RADICALMART_TELEGRAM_COPY'); ?>
                            </button>
                        <?php elseif ($refCode->link): ?>
